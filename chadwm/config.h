...
static const char *wall_change[] = { "/usr/bin/feh", "--no-fehbg", "--bg-fill", "--randomize", "~/wallz/One-Dark/*" };
#define ICONSIZE 19   /* icon size */
#define ICONSPACING 8 /* space between icon and title */

static const char *fonts[]          = {"RecMonoCasual Nerd Font Propo:style:medium:size=12" ,"JetBrainsMono Nerd Font Mono:style:medium:size=19" };
